...
# Eingeben einfordern
a = float(input("Gib eine Zahl ein für Variable a einer quadratischen Gleichung"))
b = float(input("Gib eine Zahl ein für Variable b einer quadratischen Gleichung"))
c = float(input("Gib eine Zahl ein für Variable c einer quadratischen Gleichung"))

print("====================")
# print("Deine Eingaben: \na = " + str(a) + ", " + "b = " + str(b) + ", " + "c = " + str(c))
print(f"Deine Eingaben: \na = {str(a)}, b= {str(b)}, c = {str(c)}")
