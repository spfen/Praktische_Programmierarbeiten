...
def choose_output():
    if len(filtered_data) > 1:
        ...
        if output_mode == "b":
            ...
            filename = input("Bitte geben Sie einen Dateinamen ein (xxxx.csv, Enter verwendet Standardname): ").strip() or "persons.csv"
            with open(filename, "w", newline='') as output_file:  # Nutzt newline='' um doppelten Zeilenabstand zu vermeiden
